  ...
  return (
    <nav className="flex justify-between items-center">
      ...
      <div className="hidden md:flex space-x-8 lg:space-x-12 xl:space-x-14">
        <Link
          href="/how-soon"
          className="font-josefin font-medium text-base lg:text-lg xl:text-xl text-gray-700 border-b-2 border-gray-700 pb-1"
        >
          How Soon
        </Link>
        <Link
      ...
      <div className="md:hidden w-full flex justify-center space-x-6">
        <Link
          href="/how-soon"
          className="font-josefin font-medium text-sm text-gray-700 border-b-2 border-gray-700 pb-1"
        >
          How Soon
        </Link>
        <Link
